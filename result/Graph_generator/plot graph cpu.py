...
cpu_mean = [float("{:.5f}".format(statistics.mean(k))) for k in zip(cpu1, cpu2,cpu3)]
cpu_sd = [float("{:.5f}".format(statistics.stdev(k))) for k in zip(cpu1, cpu2,cpu3)]
...
dcpu_mean = [float("{:.5f}".format(statistics.mean(k))) for k in zip(dcpu1, dcpu2,dcpu3)]
dcpu_sd = [float("{:.5f}".format(statistics.stdev(k))) for k in zip(dcpu1, dcpu2,dcpu3)]
