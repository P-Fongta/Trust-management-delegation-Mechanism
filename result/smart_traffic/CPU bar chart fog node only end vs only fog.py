...
plt.bar(r, cpu_mean, yerr=CI, color = 'tab:blue',align='center', alpha=0.8,capsize=8,
        width = width, edgecolor = 'black',
        label='only end nodes')
plt.bar(r+0.25 , cpu2_mean, yerr=CI2, color = 'tab:orange',align='center', alpha=0.8,capsize=8,
        width = width, edgecolor = 'black',
