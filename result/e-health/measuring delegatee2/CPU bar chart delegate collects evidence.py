...
for p in range(1,11):
    ...
    for z in range(1,4):
        ...
        for line in open(f'C:\\data generator\\e-health\\measuring delegatee2\\delegatee does not collect evidence\\result\\server_delegation{p}-{z}.txt', "r"):
            try:
...
for p in range(1,11):
    ...
    for z in range(1,4):
        ...
        for line in open(f'C:\\data generator\\e-health\\measuring delegatee2\\delegatee collects evidence\\result\\server_delegation{p}-{z}.txt', "r"):
            try:
                lines = [i for i in line.split()]
                cpu_p1 = lines[0].split(":")[0]
                cpu_p23 = lines[0].split(":")[1].split(".")
