...
for p in range(1,11):
    ...
    for z in range(1,4):
        ...
        for line in open(f'C:\\data generator\\e-health\delegation\\delegate collect evidence\\result\\Do_delegation{p}-{z}.txt', "r"):
            try:
...
for p in range(1,11):
    ...
    for z in range(1,4):
        ...
        for line in open(f'C:\\data generator\\e-health\delegation\\endnode collect evidence itself\\result\\Do_delegation{p}-{z}.txt', "r"):
            try:
                lines = [i for i in line.split()]
